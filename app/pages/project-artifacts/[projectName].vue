      ...
      <div v-else-if="data" class="space-y-12 max-w-6xl mx-auto">
        ...
        <section>
          <div class="flex items-center gap-3 mb-6 border-b pb-3" style="border-color: var(--border-subtle);">
            ...
            <div>
              <h3 class="text-[18px] font-semibold" style="color: var(--text-primary);">Memory Files</h3>
              <p class="text-[13px]" style="color: var(--text-secondary);">Persistent facts Claude recalls across sessions for this project</p>
            </div>
          </div>
          <ProjectMemoryManager :project-name="projectName" />
        </section>
        <section>
          <div class="flex items-center gap-3 mb-6 border-b pb-3" style="border-color: var(--border-subtle);">
            <div class="p-2 rounded-lg" style="background: rgba(251, 191, 36, 0.1);">
